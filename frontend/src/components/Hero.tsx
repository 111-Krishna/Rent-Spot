...
import { SignedIn, SignInButton, useAuth } from "@clerk/clerk-react";
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-primary-foreground px-6">
        ...
        <p className="mt-6 text-center text-primary-foreground/80 font-body text-base sm:text-lg max-w-2xl font-light animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="mt-10 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          <a
            ...
            className="text-label text-primary-foreground/60 hover:text-primary-foreground transition-colors flex flex-col items-center gap-2"
          >
            <span>Get Started</span>
            <span className="w-px h-8 bg-primary-foreground/40" />
          </a>
        </div>
      </div>
    </section>
